...
//NO FRAMES in divs
	function getButtonsTemplate(settings) {
		var $buttons = $("" +
			"<div class='aiia-wizard-buttons-wrapper flex-container container-fluid' style=' justify-content: space-between;' >" +
				"<div class='col'> <button class='btn btn-primary pull-left aiia-wizard-button-previous'></button></div>" +

					"<div class='col' style ='text-align: right;'> <button class='btn btn-primary pull-right aiia-wizard-button-next' data-loading-text='" + settings.aiiaWizard.localization.buttons.loading + "'></button> </div>" +
				 +
		"").css({
			'/*display': 'block*/'
		});
